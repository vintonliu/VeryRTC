/* exosip-config.h.  Generated from exosip-config.h.in by configure.  */
/* exosip-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Defined to 1 if compiled with NAPTR and SRV support. */
#define SRV_RECORD 1
